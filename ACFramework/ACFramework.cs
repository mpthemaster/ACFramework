...
namespace ACFramework
{
    class Framework : GameWindow
    {
        ...
        public static float _runspeed = 1.0f;  // can increase to about 10 if desired
        public static long savetime = 0;  // used to help calculate dt
        public static cKeyInfo keydev;  // stores information about keys
        private static ACView view;  // has to do with drawing the scenery and critters
        public static ACDoc pdoc;   // has to do with establishing the game
        ...
        public static bool leftclick = false;  // set to true if left mouse button is clicked
