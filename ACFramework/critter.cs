...
namespace ACFramework
{
    ...
    class cCritter
    {
        ...
        public static float MAXSPEED = 3.0f; // Used in randomizing, and to clamp _speed in move(dt).
        ...
        public static float MINRADIUS = 0.3f; //Used in randomizing 
        public static float MAXRADIUS = 0.8f;
        public static float BULLETRADIUS = 0.05f; //Gets set to cGame::BULLETRADIUS in cGame constructor.
...
//            _metrickey = -1; //Put in a bad index by default 
        ...
        /// </summary>
        /// <param name="pactiveview">This argument was useful in 2D, but probably is no longer useful.  I should get rid of it.</param>
