...
namespace ACFramework
{
    class BitmapRes
    {
        ...
        public static readonly int Key = 9;
        ...
        public static readonly int Lava = 14;
        public static readonly int Egg = 15;
        public static readonly int Health = 16;
    ...
    class Sound
    {
        ...
        public static readonly int eggSplat = 6;
        public static readonly int poisonSplat = 7;
        public static readonly int plutonium = 8; 
